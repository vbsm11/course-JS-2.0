...
let ar1 = ['Владимир', 24, 'Якимов', false, 1, true];
...
let ar2 = ['Владимир', 24, 'Якимов', false, 1, true];
...
let ar3 = ['Владимир', 24, 'Якимов', false, 1, true];
...
let ar4 = ['Владимир', 24, 'Якимов', false, 1, true, 2, 3, 4];
...
// let ar6 =
let ar6 = ['Владимир', 'Водолей', 1, 'Февраль'];
...
function f16() {
    ...
    document.querySelector('.out-16-even').innerHTML = outev;
    document.querySelector('.out-16-odd').innerHTML = outod;
}
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = imin;
}

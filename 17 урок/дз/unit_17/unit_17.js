...
function t14() {
    return a14.includes(a14_sym) || a14.includes(a14_sym.toLowerCase()) || a14.includes(a14_sym.toUpperCase());
}
...
function t15() {
    a15_res = a15.filter((elem, index) => {
        if (elem.pnum.length == 6) return true;
    })
    return a15_res;
}

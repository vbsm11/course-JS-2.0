...
let e1 = '3';
let f1 = 5;
document.querySelector('.out-4').textContent = e1 + f1; // складываем строку с числом, а не число с числом, как в прошлом задании
...
function t10() {
    ...
    document.querySelector('.out-10').textContent = data2 * 20;
}
...
function t13() {
    a = +document.querySelector('.i-13-1').value;
    b = +document.querySelector('.i-13-2').value; // Переменные a и b объявлены в Task 1
...
function t16() {
    let input1 = document.querySelector('.i-16-1').value;
    let input2 = document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').textContent = input1 + input2;
}
...
function t18() {
    a = document.querySelector('.i-18').value;
...
function t19() {
    let input191 = +document.querySelector('.i-19-1').value;
    let input192 = +document.querySelector('.i-19-2').value;
    document.querySelector('.out-19').textContent = input191 + input192;
}

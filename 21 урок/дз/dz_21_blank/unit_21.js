...
function t3(event) {
    ...
    else document.querySelector('.out-3').textContent = 2;
}
...
function t8() {
    let out8 = Math.floor(Math.random() * a8.length)
    document.querySelector('.div-8').style.background = a8[out8];
}
...
const next = document.querySelector('.next').addEventListener("touchstart", nextFunction);
// next.onclick = nextFunction;

const prev = document.querySelector('.prev').addEventListener("touchstart", prevFunction);
// prev.onclick = prevFunction;

const reset = document.querySelector('.reset').addEventListener("touchstart", resetFunction);
...
function nextFunction() {
    ...
    document.querySelector('.img-12-max').src = images[count].getAttribute('src');
}

...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=324&num2=4353')
        .then(response => response.text())
        .then(response => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=43242&num2=56456')
        .then(response => response.text())
        .then(response => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=4643&num2=46436')
        .then(response => response.text())
        .then(response => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=2&name=Vladimir', // body data type must match "Content-Type" header
    })
        .then(response => response.text())
        .then(response => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=56456&num2=74755', // body data type must match "Content-Type" header
    })
        .then(response => response.text())
        .then(response => {
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=56456&num2=74755', // body data type must match "Content-Type" header
    })
        .then(response => response.text())
        .then(response => {
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=56456&num2=74755', // body data type must match "Content-Type" header
    })
        .then(response => response.text())
        .then(response => {
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=8&year=1998', // body data type must match "Content-Type" header
    })
        .then(response => response.text())
        .then(response => {
...
function t18() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=7859d9d42a8834141d529577207c9596&action=9&y=1', // body data type must match "Content-Type" header
    })
        .then(response => response.text())
        .then(response => {

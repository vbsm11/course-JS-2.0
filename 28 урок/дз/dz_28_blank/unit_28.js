...
let goods = new Goods('Наименование', 'Цена');
console.log(goods);
...
let goods2 = new Goods('Тыква', '1$', '2', '5 шт.');
goods2.draw('.out-4');
...
let goods3 = new Goods2('Тыква', '1$', '2', '5 шт.', true);
goods3.draw('.out-6');
...
let valid8 = new Valid('valid@mail.ru', '12345');
valid8.validate();
...
let valid9 = new Valid('valid@mail.ru', '1234567');
valid9.validate();
...
let valid3 = new Valid2('valid@mail.ru', '12345678');
valid3.validate();
console.log(valid3);
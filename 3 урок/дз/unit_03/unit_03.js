...
function f3() {
   let a = +document.querySelector('.i-31').value; // имена переменных, объявляемых в ф-ции, могут использоваться при объявлении переменных в других ф-циях
...
document.querySelector('.s-110').onchange = f11; // onchange - при изменении значения select

...
document.querySelector('.s-17').onchange = f17; // срабатывает при изменении значения select
...
function f19() {
    ...
    document.querySelector('.i-19').value = out19.innerHTML; // св-во innerHTML выводит содержимое элемента div
}

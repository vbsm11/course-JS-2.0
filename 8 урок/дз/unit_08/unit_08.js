...
function t7() {
    let p7 = document.querySelector('.i-7').value;
    let out = '';
    while (p7 >= 0) {
        out += p7 + '_';
        p7--
...
function t8() {
    let p81 = document.querySelector('.i-81').value;
    let p82 = document.querySelector('.i-82').value;
    let out = '';
    while (p81 <= p82) {
        out += p81 + '_';
        p81++
...
function t9() {
    let p91 = document.querySelector('.i-91').value;
    let p92 = document.querySelector('.i-92').value;
    let out = '';
    if (p91 < p92) {
        while (p91 <= p92) {
            out += p91 + '_';
